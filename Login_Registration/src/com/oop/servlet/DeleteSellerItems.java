...
/**
 * Servlet implementation class DeleteSellerItems
 */
@WebServlet("/DeleteSellerItems")
public class DeleteSellerItems extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteSellerItems() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			boolean x = i.DeleteSellerItems(id);
